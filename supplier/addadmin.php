...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="position-sticky pt-3">
      ...
      <img src="images/<?php echo $_SESSION["profile"]?>" style="border-radius:50%;" alt="user-img" width="50"
                                    class="img-circle me-2"></a>
                                    <span class="text-white font-medium text-center"> 
                                        <?php echo $_SESSION["name"];?>
                                        <?php if($_SESSION["role"]=='3'){
                                       ?><p><?php echo $_SESSION["position"];
                                       }else if($_SESSION["role"]=='3'){
                                        ?><p><?php echo $_SESSION["company"];
                                        }?>
                                          </p>
                                    </span>
      </div>
      ...
      <div class="r pt-3 pb-2 mb-3 ">
        ...
        <div class="card shadow border-0 mb-7" style="margin-top:30px;">
                   ...
                   <form class="p-4 pt-3" action="operation.php" method="post" enctype="multipart/form-data">
                    ...
                    <label>Contact</label>
                    <input type="number" name="contact" class="form-control mb-2">
                    <label>Gender</label>
                    ...
                    <button class="btn btn-primary" name="addadmin" style="background-color: #ff6b6b ;border:none;" type="submit">Add Customer</button>
                   </form>
                </div>
