...
<!-- content inside the main-->
    ...
    <?php if(isset($_GET['error'])){?>
                ...
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>     
                <?php }?>
      <div class="r pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2 border-bottom">Dashboard</h1>
        <div class=container-fluid>
        <div class="row g-6 mb-6 d-flex">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <span class="h3 font-bold mb-0">FCFA 11590.90</span>
                                    </div>
                                    <div class="col-auto">
                    ...
                    <div class="col-xl-4 col-sm-4">
                        <div class="card shadow border-0">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <span class="h6 font-semibold text-muted text-sm d-block mb-2">Total Suppliers</span>
                                        <span class="h3 font-bold mb-0">
                                        <?php
                        ...
                        <table class="table table-hover table-nowrap">
                            ...
                            $role=$_SESSION['role'];
                                ...
                                <tr>
                                  ...
                                  ?>
                                    <td class="d-flex">
                                        <img alt="..." src="../admin/images/<?php $row2=$rs2->fetch_assoc(); echo $row2['profilepic']?>" width="30" height="30" class="avatar avatar-sm rounded-circle me-2">
                                        <p>
                                        <?php
