    ...
    <?php if(isset($_GET['error'])){?>
      ...
      <div class="r pt-3 pb-2 mb-3 ">
        ...
        <div class="card shadow border-0 mb-7" style="margin-top:30px;">
                    ...
                    <input type="text" name="password" value="<?php echo $row1['password']?>" class="form-control mb-2">
                    <label>Gender</label>
                    <select name="gender" class="form-control mb-2">
                        <?php if ($row1['password']=="male"){ ?>
                    ...
                    <label>Company</label>
                    <input type="text" name="company" value="<?php echo $row1['company']?>" class="form-control mb-2">
                    <label>Description</label>
                    <textarea  name="des"  class="form-control mb-2"><?php echo $row1['description']?></textarea>
                    <label>Supplier Image</label>
                    <input type="file" name="profilepic" class="form-control mb-2 me-2" multiple accept="image/*">
                    <button class="btn btn-primary" name="updatesup" style="background-color: #ff6b6b ;border:none;" type="submit">Edit Profile</button>
                   </form>
                </div>
