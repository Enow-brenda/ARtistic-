...
<!-- content inside the main-->
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="r pt-3 pb-2 mb-3 ">
        ...
        <div class=container-fluid>
        <?php
        $myid= $_SESSION['supplierid'];
        $role=$_SESSION['role'];
        $query1 = "SELECT * FROM `messages` where receivertype=$sendrole && receiverid=$sendid && senderid=$myid && sendertype=$role";
           $rs1 = $conn->query($query1);
        ...
        <div class="card shadow border-0 mb-7" style="margin-top:30px;">
                    <div class="card-header" >
                        <h5 class="mb-0">subject: <?php echo $row1['subject']?></h5>
              ...
              <div class="card-body">
                ...
                <p class="card-text px-2"><?php echo $row1['description']?></p>
                <?php 
                if($row1['file']!=""){
                  ?>
                  <p><b>Attachment Name:</b> <?php echo $row1['file']?></p>
                 <a href="../admin/messageattach/<?php echo $row1['file']?>" class="btn btn-success">Download the File</a>
                  <?php }?>
              </div>
              <div class="card-footer text-muted d-flex" style="justify-content: space-between;">
              <?php echo $row1['datecreated']?>
              <a href="operation.php?deletemessageid=<?php echo $id?>" class="btn btn-danger">Delete Message</a>
              </div>
