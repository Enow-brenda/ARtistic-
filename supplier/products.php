        ...
        <div class="card shadow border-0 mb-7" style="margin-top:30px;">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-nowrap">
                            ...
                            <tbody>
                            <?php
                                $creatorrole=$_SESSION['role'];
                                $creatorid= $_SESSION['supplierid'];
                                 $query1 = "SELECT * FROM `product` where creatorrole='$creatorrole' && creatorid='$creatorid'";
                                 $rs1 = $conn->query($query1);
                                 $num1 = $rs1->num_rows;
                                 if($num1>0){
                                  $count=1;
                                ...
                                <tr>
                                  ...
                                  <td><?php echo $count?></td>
                                    <td class="d-flex">
                                        <img alt="..." src="../admin/images/<?php echo $row1['mainpic']?>" width="30" height="30" class="avatar avatar-sm rounded-circle me-2">
                                        <p>
