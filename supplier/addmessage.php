      ...
      <div class="r pt-3 pb-2 mb-3 ">
        ...
        <div class="card shadow border-0 mb-7" style="margin-top:30px;">
                   ...
                   <form class="p-4 pt-3" action="operation.php" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="sendid"value="<?php echo  $_SESSION['supplierid']?>">
                    <input type="hidden" name="role" value="<?php echo $_SESSION['role']?>">
                   <div class="d-flex">
                            <ul>
                                <h6 class="text-center">Administrators</h6>
                                <?php
                                 ...
                                 while($row1 = $rs1->fetch_assoc()){
                                  ?>
                                   <li class="d-flex" >
                                    <input type="checkbox" name="admin[]" value="<?php echo $row1['adminid']?>" width="30px">

                                        <p>
                                           <?php echo $row1['position']." - ".$row1['name'];?> 
                                       </p>
                                </li>
                                  <?php
                                 }
                            ...
                            <ul>
                                <h6 class="text-center">Suppliers</h6>
                                <?php
                                 ...
                                 while($row1 = $rs1->fetch_assoc()){
                                  ?>
                                   <li class="d-flex" >
                                    <input type="checkbox" name="supplier[]" value="<?php echo $row1['supplierid']?>"width="30px">

                                        <p>
                                        <?php echo $row1['name']." - ".$row1['company'];?> 
                                       </p>
                                </li>
                                  <?php
                                 }
                    ...
                    <textarea name="des"class="form-control mb-2"></textarea>
                    
                    <label>Attach File</label>
                    <input type="file" name="file" class="form-control mb-2 me-2">
                    <button class="btn btn-primary" name="sendmessage"style="background-color: #ff6b6b ;border:none;" type="submit">Send Message</button>
                   </form>
                </div>
