...
<!-- content inside the main-->
    ...
    <?php if(isset($_GET['error'])){?>
      ...
      <div class="r pt-3 pb-2 mb-3 ">
        ...
        <div>
        <a href="product.php" class="btn d-inline-flex btn-sm btn-danger border-base mx-1">
                                    <span class=" pe-2">
        ...
        <div class="card shadow border-0 mb-7" style="margin-top:30px;">
                   ...
                   <input type="hidden" value="<?php echo $_SESSION['adminid'];?>" name="creatorid" class="form-control mb-2">
                    <input type="hidden" value="<?php echo $_SESSION['role'];?>" name="creatorrole" class="form-control mb-2">
                    <label>Product Name</label>
                    <input type="text" name="pname" class="form-control mb-2">
                    <label>Product Description</label>
                    <input type="text" name="pdes" class="form-control mb-2">
                    ...
                    <div class="d-flex">
                        <input type="number" class="form-control mb-2 me-2" name="length" placeholder="Enter length">
                        <input type="number" class="form-control mb-2 me-2" name="width" placeholder="Enter Width">
                        <input type="number" class="form-control mb-2"  name="height" placeholder="Enter Height">
                    </div>
                    ...
                    <button class="btn btn-primary" style="background-color: #ff6b6b ;border:none;" name="addproduct" type="submit">Add Product</button>
                   </form>
                </div>
