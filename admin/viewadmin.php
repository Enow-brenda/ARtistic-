...
session_start();
  ...
  $myid=$_SESSION['adminid'];
    ...
    $query = "SELECT * FROM admin where `adminid`=$myid";
      $rs = $conn->query($query);
        $row=$rs->fetch_assoc();
?>
<!doctype html>
        ...
        <div class="row ">
            ...
            <div class="col-12 col-lg-6 col-md-6">
                ...
                <img src="images/<?php echo $row1['profilepic']?>" class="rounded img-fluid  card-img-top"  style="height: 300px "  alt="...">
                    ...
                    <h4 class="text-center mb-4"><?php echo $row1['position']?></h4>
                        ...
                        <p class="card-text">Class: <?php echo $row1['class']?> </p>
    ...
    <?php if($row1['class']=='A'){?>
        <div class="card shadow border-0 mb-7 " style="margin-top:30px;">
                    <div class="card-header">
                        <h5 class="mb-0 p-2">Supply Details</h5>
                    </div>
                    ...
                    <h6>Total Products:
                      <?php  $query1 = "SELECT * FROM product where creatorid='$id' && creatorrole='1'";
    $rs1 = $conn->query($query1);
    $row1 = $rs1->fetch_assoc();
    $num1=$rs1->num_rows;
    echo $num1?> </h6>
                    ...
                    <div class="table-responsive p-2">
                        <table class="table table-hover table-nowrap">
                            ...
                            <?php }else{
                              ?>
                              <tr><td colspan="6" class="text-center"><b>No Product Created</b></td></tr>
                              <?php }?>
                        </table>
                    </div>
