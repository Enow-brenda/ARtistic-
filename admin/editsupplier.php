...
$id=$_SESSION['adminid'];
    ...
    $query1="SELECT * FROM `supplier` where supplierid='$sid' ";
...
<!-- content inside the main-->
    ...
    <?php if(isset($_GET['error'])){?>
      ...
      <div class="r pt-3 pb-2 mb-3 ">
        ...
        <div>
        <a href="suppliers.php" class="btn d-inline-flex btn-sm btn-danger border-base mx-1">
                                    <span class=" pe-2">
        ...
        <div class="card shadow border-0 mb-7" style="margin-top:30px;">
                   ...
                   <label>Secret Key</label>
                    ...
                    <button class="btn btn-primary" name="updsup" style="background-color: #ff6b6b ;border:none;" type="submit">Edit Supplier</button>
                   </form>
                </div>
