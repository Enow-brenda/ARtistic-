      ...
      <div class="r pt-3 pb-2 mb-3 ">
        ...
        <div class="card shadow border-0 mb-7" style="margin-top:30px;">
                   ...
                   <form class="p-4 pt-3" action="operation.php" method="post" enctype="multipart/form-data">
                    <label>coupon</label>
                    <input type="text" name="coupon" class="form-control mb-2" required> 
                    <label>Discount Percentage</label>
                    <input type="number" name="percent" class="form-control mb-2">
                    ...
                    <button class="btn btn-primary" style="background-color: #ff6b6b ;border:none;" name="adddiscount" type="submit">Add Disount</button>
                   </form>
                </div>
