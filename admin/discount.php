...
<!-- content inside the main-->
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <?php if(isset($_GET['error'])){?>
        ...
        <div>
        <?php if($row['class']=='A'){?>
        <a href="adddiscount.php" class="btn d-inline-flex btn-sm btn-success border-base mx-1">
                                    <span class=" pe-2">
                                        <i class="fa fa-plus"></i>
                                    </span>
                                    <span>Add Disount</span>
                                </a>
    <?php }?>
        </div>
                                ...
                                <tr>
                                  ...
                                  <td><?php echo $count?></td>
                                    <td class="d-flex">
                                        ...
                                        <p>
                                            <?php echo $row1['coupon'];?>
                                       </p>
                                    </td>
                                    <td>
                                    <?php echo $row1['discountpercent']?>
                                    </td>
                                    <td>
                                    <?php echo $row1['startdate']?>
                                    </td>
                                    <td>
                                    <?php echo $row1['enddate']?>
                                    </td>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <?php if($row['class']=='A'){?>
                                        <a href="editdiscount.php?id=<?php echo $id?>" class="btn btn-sm btn-secondary" >Edit</a>
