...
$cid=$_GET['id'];
    ...
    $rs = $conn->query($query);
    $row = $rs->fetch_assoc();
    $query1="SELECT * FROM `customer` where customerid='$cid' ";
      ...
      <div class="r pt-3 pb-2 mb-3 ">
        ...
        <div class="card shadow border-0 mb-7" style="margin-top:30px;">
                    <div class="card-header">
                        <h5 class="mb-0">Edit Customers Details</h5>
                    </div>
                   <form class="p-4 pt-3" action="operation.php" method="post" enctype="multipart/form-data">
                    <label>Username</label>
                    <input type="hidden" name="id" value="<?php echo $cid?>">
                    <input type="text" name="username" value="<?php echo $row1['username'];?>" class="form-control mb-2">
                    <label>Name</label>
                    ...
                    <button class="btn btn-primary" style="background-color: #ff6b6b ;border:none;" name="updcustomer" type="submit">Edit Customer</button>
                   </form>
                </div>
