...
<!-- content inside the main-->
      ...
      <div class="r pt-3 pb-2 mb-3 ">
        ...
        <div class="card shadow border-0 mb-7" style="margin-top:30px;">
                   ...
                   <form class="p-4 pt-3" action="operation.php" method="post" enctype="multipart/form-data">
                    ...
                    <button class="btn btn-primary" style="background-color: #ff6b6b ;border:none;" name="addcustomer" type="submit">Add Customer</button>
                   </form>
                </div>
    ...
    <script src="sidebars.js"></script>
      ...
      <script src="https://cdn0.jsdelivr.net/npm/feather-icons@4.28.0/dist/feather.min.js" integrity="sha384-uO3SXW5IuS1ZpFPKugNNWqTZRRglnUJK6UAZ/gxOX80nxEkN9NcGZTftn6RzhGWE" crossorigin="anonymous"></script><script src="https://cdn.jsdelivr.net/npm/chart.js@2.9.4/dist/Chart.min.js" integrity="sha384-zNy6FEbO50N+Cg5wap8IKA4M/ZnLJgzc6w2NqACZaK0u0FXfOWRRJOnQtpZun8ha" crossorigin="anonymous"></script><script src="dashboard.js"></script>
  </body>
</html>
