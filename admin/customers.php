...
<!-- content inside the main-->
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <?php if(isset($_GET['error'])){?>
        ...
        <div>
        <?php if($row['class']=='A'){?>
        <a href="addcustomer.php" class="btn d-inline-flex btn-sm btn-success border-base mx-1">
                                    <span class=" pe-2">
                            ...
                            <?php
                                ...
                                <tr>
                                  ...
                                  <td><?php echo $count?></td>
                                    ...
                                    <td class="text-end">
                                        <a href="viewcustomer.php?id=<?php echo $id?>" class="btn btn-sm btn-neutral" style="border:1px black solid">View</a>
                                        <?php if($row['class']=='A'){?>
                                        <a href="editcustomer.php?id=<?php echo $id?>" class="btn btn-sm btn-secondary" >Edit</a>
