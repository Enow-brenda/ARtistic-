...
<!-- content inside the main-->
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <?php if(isset($_GET['error'])){?>
        ...
        <div>
        <?php if($row['class']=='A'){?>
        <a href="addadmin.php" class="btn d-inline-flex btn-sm btn-success border-base mx-1">
                                    <span class=" pe-2">
                              ...
                              ?>
                                <tr>
                                  <td><?php echo $count?></td>
                                    <td class="d-flex">
                                        <img alt="..." src="images/<?php echo $row1['profilepic']?>" class="avatar avatar-sm rounded-circle me-2" width="30" height="30">
                                        <p>
                                           <?php echo $row1['name']?>
                                       </p>
                                    </td>
                                    ...
                                    <td class="text-end">
                                      <?php
                                      if($row1['secretkey']==$_SESSION['secretkey'] ){
                                        ?>
                                        <a href="profile.php" class="btn btn-sm btn-neutral" style="border:1px pink solid">Profile</a>
                                      <?php }else{?>
                                        <a href="viewadmin.php?id=<?php echo $row1['adminid'];?>" class="btn btn-sm btn-neutral" style="border:1px black solid">View</a>
                                        <?php if($row['class']=='A'){?>
                                        <a href="editadmin.php?id=<?php echo $row1['adminid'];?>" class="btn btn-sm btn-secondary" >Edit</a>
                                ...
                                <?php $count++; 
                                  ...
                                  ?><tr><td colspan="6" class="text-center"><b><?php echo "No Data Record Found"; ?></b></td></tr><?php
