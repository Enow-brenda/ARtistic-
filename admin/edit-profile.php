...
<button class="navbar-toggler  d-md-none collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#sidebarMenu" aria-controls="sidebarMenu" aria-expanded="false" aria-label="Toggle navigation">
  ...
  <input class="form-control me-2"  type="search"  placeholder="Search" aria-label="Search">
        ...
        <a class="profile-pic dropdown-toggle" style="text-decoration:none;" id="dropdownUser3" data-bs-toggle="dropdown" aria-expanded="false" href="#">
                                ...
                                <img src="../admin/images/<?php echo $row1['profilepic']?>"  style="border-radius:50%;" alt="user-img" width="36"
...
<!-- content inside the main-->
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <?php if(isset($_GET['error'])){?>
        ...
        <div>
        <a href="profile.php" class="btn d-inline-flex btn-sm btn-danger border-base mx-1">
                                    <span class=" pe-2">
        ...
        <div class="card shadow border-0 mb-7" style="margin-top:30px;">
                    ...
                    <form class="p-4 pt-3" action="operation.php" method="post" enctype="multipart/form-data">
                    <label>Secret Key</label>
                    <input type="hidden" name="id" value="<?php echo $_GET['id']?>">
                    <input type="text" name="key" value="<?php echo $row1['secretkey']?>" class="form-control mb-2">
                    <label>Name</label>
                    <input type="text" name="name" value="<?php echo $row1['name']?>" class="form-control mb-2">
                    <label>Password</label>
                    <input type="password" name="password" value="<?php echo $row1['password']?>" class="form-control mb-2">
                    <label>Gender</label>
                    ...
                    <select name="class" class="form-control mb-2">
                        ...
                        <?php }else if($row1['class']=="B"){?>
                          <option  value="A">A</option>
                        <option selected value="B">B</option>
                        <option value="C">C</option>
                        
                        <?php }else if($row1['class']=="C"){?>
                          <option  value="A">A</option>
                        <option  value="B">B</option>
                    ...
                    <label>Email</label>
                    <input type="email" name="email"value="<?php echo $row1['email']?>"  class="form-control mb-2">
                    <label>Contact</label>
                    <input type="text" name="contact" value="<?php echo $row1['contact']?>" class="form-control mb-2">
                    <label>Position</label>
                    <input type="text" name="position" value="<?php echo $row1['position']?>" class="form-control mb-2">
                    <label>Date of Birth</label>
                    <input type="date" name="dob" value="<?php echo $row1['dateofbirth']?>" class="form-control mb-2">
                    <label>Admin Image</label>
                    <input type="file" name="profilepic" class="form-control mb-2 me-2" multiple accept="image/*">
                    <button class="btn btn-primary" name="updateadm" style="background-color: #ff6b6b ;border:none;" type="submit">Edit Profile</button>
                   </form>
                </div>
