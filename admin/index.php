...
<div class="container-fluid">
  <div class="row">
    <nav id="sidebarMenu" style="height:36rem" class="col-md-3 col-lg-2 d-md-block bg-dark sidebar collapse">
                        ...
                        <table class="table table-hover table-nowrap">
                            ...
                            <tbody>
                                <?php
                                 ...
                                 if($num1 > 0){
                                    $id=$rows1['orderid'];
                                    $query2 = "SELECT * FROM `deliveryandorder` where orderid='$id'";
                                    $rs2 = $conn->query($query2);
                                    $rows2 = $rs2->fetch_assoc();
                                    $delivery=$rows2['deliverystatus'];
                                ...
                                <tr>
                                  <td><?php echo $rows1['orderid']?></td>
                                    ...
                                    <td>
                                    <?php echo $rows1['datecreated']?>
                                    </td>
                                    <td class="text-end">
                                        <a href="#" class="btn btn-sm btn-neutral" style="border:1px black solid">View</a>
