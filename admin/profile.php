        ...
        <div class="col-12 col-lg-6 col-md-6">
            ...
            <img src="images/<?php echo $row1['profilepic']?>" class="rounded img-fluid  card-img-top"  style="height: 300px "  alt="...">
                ...
                <h4 class="text-center mb-4"><?php echo $row1['position']?></h4>
                    ...
                    <p class="card-text">Date of Birth: <?php echo $row1['dateofbirth']?> </p>
                    <p class="card-text">Age: 22 
                    </p>
                    
                    <p class="text-center">
                    <a href="edit-profile.php?id=<?php echo $id?>" class="btn btn-outline-primary">Edit Profile</a>
