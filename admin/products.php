...
<!-- content inside the main-->
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <?php if(isset($_GET['error'])){?>
        ...
        <div>
        <a href="addproduct.php" class="btn d-inline-flex btn-sm btn-success border-base mx-1">
                                    <span class=" pe-2">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-nowrap">
                            ...
                            <?php
                                 ...
                                 ?>
                                <tr>
                                  <?php $id=$row1['productid'];?>
                                  <td><?php echo $count?></td>
                                    <td class="d-flex">
                                        <img alt="..." src="images/<?php echo $row1['mainpic']?>" width="30" height="30" class="avatar avatar-sm rounded-circle me-2">
                                        <p>
                                            <?php echo $row1['productname'];?>
                                       </p>
                                    </td>
                                    <td>
                                    <?php echo $row1['price'].'XAF'?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                            ...
                                            $query2 = "SELECT * FROM category where categoryid='$category'";
                                    ...
                                    <td>
                                      ...
                                      if ($row1['creatorrole']==1){
                                          $query3 = "SELECT * FROM admin where adminid='$creatorid'";
                                          $rs3 = $conn->query($query3);
                                          $row3 = $rs3->fetch_assoc();
                                          echo $row3['position']." - ".$row3['name']; 
                                      }else{
                                        $query3 = "SELECT * FROM supplier where supplierid='$creatorid'";
                                          $rs3 = $conn->query($query3);
                                          $row3 = $rs3->fetch_assoc();
                                          echo "Supplier - ".$row3['name']; 
                                      }?>
                                    </td>
                                    ...
                                    <td class="text-end">
                                        <a href="viewproduct.php?id=<?php echo $id?>" class="btn btn-sm btn-neutral" style="border:1px black solid">View</a>
                                        <?php if($row['class']=='A'){?>
                                        <a href="editproduct.php?id=<?php echo $id?>" class="btn btn-sm btn-secondary" >Edit</a>
