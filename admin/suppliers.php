...
<!-- content inside the main-->
    ...
    <?php if(isset($_GET['error'])){?>
      ...
      <div class="r pt-3 pb-2 mb-3 ">
        ...
        <div>
        <?php if($row['class']=='A'){?>
        <a href="addsupplier.php" class="btn d-inline-flex btn-sm btn-success border-base mx-1">
                                    <span class=" pe-2">
                        ...
                        <table class="table table-hover table-nowrap">
                            ...
                            if($num1>0){
                                ...
                                <tr>
                                  ...
                                  echo $count?></td>
                                    <td class="d-flex">
                                        <img alt="..." src="images/<?php echo $row1['profilepic']?>" width="30" height="30" class="avatar avatar-sm rounded-circle me-2">
                                        <p>
                                        <?php echo $row1['name']?> 
                                       </p>
                                    </td>
                                    ...
                                    <td class="text-center">
                                       <?php
                                 $query2 = "SELECT * FROM `product` WHERE creatorrole=2 AND creatorid=$id";
                                 ...
                                 echo $num2?>
                                    ...
                                    <td class="text-end">
                                        <a href="viewsupplier.php?id=<?php echo $id?>" class="btn btn-sm btn-neutral" style="border:1px black solid">View</a>
                                        <?php if($row['class']=='A'){?>
                                        <a href="editsupplier.php?id=<?php echo $id?>" class="btn btn-sm btn-neutral" style="border:1px black solid">Edit</a>
